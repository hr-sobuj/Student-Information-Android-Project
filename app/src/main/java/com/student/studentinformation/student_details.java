...
public class student_details extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.nav_student_details);
        ...
        if(bundle!=null){
            ...
            valx=bundle.getString("key");
            val1x=bundle.getString("spinkey");
        }
        ...
        btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent=new Intent(student_details.this,info.class);
                intent.putExtra("key",valx);
                intent.putExtra("spinkey",val1x);
    ...
    private void makePhoneCall() {
        if(ContextCompat.checkSelfPermission(student_details.this,
                Manifest.permission.CALL_PHONE) != PackageManager.PERMISSION_GRANTED){
            ActivityCompat.requestPermissions(student_details.this,
