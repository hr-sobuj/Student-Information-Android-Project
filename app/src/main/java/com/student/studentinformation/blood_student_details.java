...
public class blood_student_details extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener{
    ...
    String val,val1,valx,val1x;
    String stdid,stdname,stdfalculty,stddept,stdblood,stdgender,stdphn,stdmail,stdjob,stdpresent,stdpast,stdimg,stdsession;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.nav_blood_student_details);
        ...
        if(bundle!=null){
            ...
            val=bundle.getString("keys");
            val1=bundle.getString("key");
        ...
        btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent=new Intent(blood_student_details.this,blood_search_result_list.class);
                intent.putExtra("blooogroup",val1);
        ...
        reference.child(val).addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                if(!dataSnapshot.exists()){
                    ...
                    Intent intent=new Intent(blood_student_details.this,info.class);
                    startActivity(intent);
    ...
    private void makePhoneCall() {
        if(ContextCompat.checkSelfPermission(blood_student_details.this,
                Manifest.permission.CALL_PHONE) != PackageManager.PERMISSION_GRANTED){
            ActivityCompat.requestPermissions(blood_student_details.this,
    ...
    public boolean onOptionsItemSelected(@NonNull MenuItem item) {
        ...
        if(item.getItemId()==R.id.backId){
            ...
            Intent intent= new Intent(this, blood_search_result_list.class);
            intent.putExtra("blooogroup",val1);
            startActivity(intent);
            finish();
