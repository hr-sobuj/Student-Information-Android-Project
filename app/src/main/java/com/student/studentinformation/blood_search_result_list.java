...
public class blood_search_result_list extends AppCompatActivity  implements NavigationView.OnNavigationItemSelectedListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.nav_blood_search_result_list);
...
/*        btn=(Button) findViewById(R.id.backid);
        ...
        if(bundle!=null){
            ...
            val=bundle.getString("blooogroup");
        ...
        firebaseAdapter=new firebase_adapter(blood_search_result_list.this,firebasess);
        ...
        DataDisplay.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                Intent intent=new Intent(blood_search_result_list.this,blood_student_details.class);
        ...
        reference.orderByChild("yesno").equalTo("Yes").addListenerForSingleValueEvent(new ValueEventListener() {
            @Override
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                if(dataSnapshot.exists()){
                 /*   progressDialog.dismiss();*/
                    ...
                    reference.orderByChild("blood").equalTo(val).addListenerForSingleValueEvent(new ValueEventListener() {
                        @Override
                        public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                            ...
                            if(dataSnapshot.exists()){
                                ...
                                Intent intent=new Intent(blood_search_result_list.this,blood_not_found.class);
                                startActivity(intent);
