...
public class updateinfopage extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener{



    private DrawerLayout mNavDrawer;
    private Button btnpersonal,btnblood,btnjobaddress;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.nav_updateinfopage);
        ...
        btnpersonal=(Button) findViewById(R.id.personalinfo);
        btnblood=(Button) findViewById(R.id.bloodinfo);
        btnjobaddress=(Button) findViewById(R.id.jobaddress);

        btnpersonal.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent=new Intent(updateinfopage.this,personalinfo.class);
        ...
        btnblood.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent=new Intent(updateinfopage.this,bloodinfo.class);
                startActivity(intent);
                finish();
            }
        });

        btnjobaddress.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent=new Intent(updateinfopage.this,jobaddress.class);
                startActivity(intent);
                finish();
            }
        });
